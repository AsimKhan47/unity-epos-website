...
const ContactUs = () => {
  ...
  return (
    <div className="bg-[#008B7C] rounded-[20px] my-10 md:my-20 mx-2 sm:mx-10 md:mx-[100px]">
      <div className="mx-4 sm:mx-[24px] py-6 md:py-[24px] flex flex-col md:flex-row gap-6 md:gap-[28px] rounded-2xl overflow-hidden min-h-[520px]">
        ...
        >
          ...
          <button
            type="submit"
            className="bg-[#008B7C] cursor-pointer hover:bg-white hover:border-[#008B7C] border hover:text-[#008B7C] text-[#FFFFFF] text-[14px] font-inter sm:text-[16px] font-medium px-[16px] py-[8px] rounded-[6px]  w-full sm:w-[86px] text-center transition"
          >
            Submit
          </button>
        </form>
